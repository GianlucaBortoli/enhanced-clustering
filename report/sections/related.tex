...
A natural evolution are the mixed approaches that try to combine the advantages of both the partitional and the hierarchical models to overcome their weaknesses.
